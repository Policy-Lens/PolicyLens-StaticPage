...
const DashboardPage = () => {
  ...
  const riskCategoriesData = {
    labels: ['Strategic', 'Financial', 'Reputational', 'People', 'Governance', 'Legal', 'Technical', 'Competition'],
    datasets: [
      {
  ...
  const risksPerEntityData = {
    labels: ['Finance', 'People', 'Marketing', 'Tech', 'Subsidiary 1', 'Subsidiary 2'],
    datasets: [
      {
        label: 'Low',
        data: [4, 2, 3, 1, 4, 5],
  ...
  const complianceTrendsData = {
    ...
    datasets: [
      {
        label: 'Cybersecurity',
        data: [1800, 200, 1600, 300, 1900, 200, 1700, 300, 1800, 200, 1900, 1600],
  ...
  const GaugeChart = () => {
    ...
    return (
      <div className="flex flex-col items-center justify-center h-full">
        ...
        <div className="text-center mt-1 text-sm font-medium text-gray-700">Medium-High Risk</div>
      </div>
    );
  };
  ...
  const RiskHeatMap = () => {
    return (
      <div className="border border-gray-100 rounded-md bg-white overflow-hidden">
        <table className="w-full">
          <thead>
            <tr>
              ...
              <th className="border border-gray-100 p-2 text-xs font-medium text-gray-600 bg-gray-50">Very Low</th>
              <th className="border border-gray-100 p-2 text-xs font-medium text-gray-600 bg-gray-50">Low</th>
              <th className="border border-gray-100 p-2 text-xs font-medium text-gray-600 bg-gray-50">Medium</th>
              <th className="border border-gray-100 p-2 text-xs font-medium text-gray-600 bg-gray-50">High</th>
              <th className="border border-gray-100 p-2 text-xs font-medium text-gray-600 bg-gray-50">Very High</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td className="border border-gray-100 p-2 text-xs font-medium text-gray-700">Very High</td>
              <td className="border border-gray-100 p-2 bg-green-100"></td>
              <td className="border border-gray-100 p-2 bg-yellow-100"></td>
              <td className="border border-gray-100 p-2 bg-red-500 text-white text-center font-medium">1</td>
              <td className="border border-gray-100 p-2 bg-red-600 text-white text-center font-medium">1</td>
              <td className="border border-gray-100 p-2 bg-red-700 text-white"></td>
            </tr>
            <tr>
              <td className="border border-gray-100 p-2 text-xs font-medium text-gray-700">High</td>
              ...
              <td className="border border-gray-100 p-2 bg-red-500 text-white text-center font-medium">2</td>
              <td className="border border-gray-100 p-2 bg-red-600 text-white"></td>
            </tr>
            <tr>
              <td className="border border-gray-100 p-2 text-xs font-medium text-gray-700">Medium</td>
              <td className="border border-gray-100 p-2 bg-green-400"></td>
              <td className="border border-gray-100 p-2 bg-green-300"></td>
              <td className="border border-gray-100 p-2 bg-yellow-300 text-center font-medium">6</td>
              <td className="border border-gray-100 p-2 bg-orange-400"></td>
              <td className="border border-gray-100 p-2 bg-red-500 text-white"></td>
            </tr>
            <tr>
              <td className="border border-gray-100 p-2 text-xs font-medium text-gray-700">Low</td>
              <td className="border border-gray-100 p-2 bg-green-500 text-white text-center font-medium">5</td>
              <td className="border border-gray-100 p-2 bg-green-400"></td>
              <td className="border border-gray-100 p-2 bg-green-300"></td>
            ...
            <tr>
              <td className="border border-gray-100 p-2 text-xs font-medium text-gray-700">Very Low</td>
              <td className="border border-gray-100 p-2 bg-green-600 text-white text-center font-medium">3</td>
        ...
        <div className="text-center mt-2 mb-1 text-xs font-medium text-gray-500">Impact</div>
      </div>
    );
  };
            ...
            <div className="flex flex-wrap gap-2 w-full md:w-auto">
              {filterOptions.map((option) => (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-all flex items-center gap-1.5 ${activeFilter === option.value
                      ? 'bg-blue-100 text-blue-700 border border-blue-200'
                      : 'bg-white text-gray-600 border border-gray-200 hover:bg-gray-50'
                    }`}
                >
                  {option.value === 'all' && <Filter size={14} />}
                  {option.value === 'high' && <AlertCircle size={14} className="text-red-500" />}
                  {option.value === 'medium' && <AlertCircle size={14} className="text-yellow-500" />}
                  {option.value === 'low' && <AlertCircle size={14} className="text-green-500" />}
                  {option.value === 'compliance' && <Shield size={14} className="text-blue-500" />}
                  {option.label}
                </button>
              ))}
            </div>
