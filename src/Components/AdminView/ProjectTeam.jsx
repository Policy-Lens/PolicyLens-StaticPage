      ...
      <div className="w-full">
        ...
        <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center mb-4 sm:mb-0">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Manage the members of your project team</p>
            </div>
          </div>
        ...
        {loading ? (
          <div className="bg-white p-10 rounded-lg shadow-xl w-full flex flex-col items-center justify-center min-h-[300px]">
            ...
            <h3 className="text-xl font-medium text-gray-700 mt-6 mb-2">Loading Team Members</h3>
            <p className="text-sm text-gray-500">Please wait while we fetch the project team information...</p>
          </div>
        ) : members.length > 0 ? (
          <div className="overflow-hidden rounded-lg border border-gray-200 shadow-md w-full">
            ...
            <div className="bg-white border-b border-gray-200 p-4">
              <div className="flex items-center mb-1">
                <h2 className="text-xl font-semibold text-gray-800 mr-2">Team Members</h2>
                <span className="text-sm bg-indigo-100 text-indigo-800 py-1 px-3 rounded-full">{members.length}</span>
              </div>
              ...
              {isEditing && (
                <div className="flex gap-3 flex-wrap mt-4">
                  ...
                  <button
                    className="bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-600 transition flex items-center shadow-md"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="grid grid-cols-3 bg-gray-50 border-b border-gray-200">
              <div className="py-3 px-6 text-left font-medium text-gray-500">NAME</div>
              <div className="py-3 px-6 text-left font-medium text-gray-500">EMAIL</div>
              <div className="py-3 px-6 text-left font-medium text-gray-500">ROLE</div>
            </div>
            ...
            <div className="bg-white divide-y divide-gray-200">
              {members.map((member, idx) => (
                ...
                >
                  <div className="py-4 px-6 text-sm font-medium text-gray-900 truncate">{member.name}</div>
                  <div className="py-4 px-6 text-sm text-gray-500 truncate">{member.email}</div>
                  <div className="py-4 px-6">
                    <span className={`px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full 
                      ${member.project_role === 'admin' ? 'bg-purple-100 text-purple-800' :
                        member.project_role === 'consultant' ? 'bg-blue-100 text-blue-800' :
                          member.project_role === 'auditor' ? 'bg-green-100 text-green-800' :
          ...
          <div className="bg-white p-8 rounded-lg shadow-md border border-gray-200 text-center w-full">
            <div className="flex flex-col items-center justify-center">
              ...
              <p className="text-gray-600 max-w-md mb-8">
                Your project doesn't have any team members. Add team members to collaborate on this project.
              </p>
              <button
                onClick={toggleEdit}
          ...
          <div className="bg-white p-6 rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto m-4">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    className={`w-full bg-gray-50 border border-gray-300 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none ${(!selectedRole || usersLoading) ? 'opacity-60 cursor-not-allowed' : ''}`}
                    value={selectedUser}
                      ...
                      {admins.map((member, index) => (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              onClick={() => {
                                setAdmins(admins.filter((admin) => admin.id !== member.id));
                              }}
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              onClick={() => {
                                setConsultants(
                                  consultants.filter((consultant) => consultant.id !== member.id)
                                );
                              }}
                              className="text-gray-400 hover:text-red-500 transition-colors rounded-full hover:bg-red-50 p-1"
                            >
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              onClick={() => {
                                setAuditors(
                                  auditors.filter((auditor) => auditor.id !== member.id)
                                );
                              }}
                              className="text-gray-400 hover:text-red-500 transition-colors rounded-full hover:bg-red-50 p-1"
                            >
