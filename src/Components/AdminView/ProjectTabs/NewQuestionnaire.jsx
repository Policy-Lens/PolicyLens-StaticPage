...
const NewQuestionnaire = (props) => {
  ...
  const [questionDetailsModal, setQuestionDetailsModal] = useState({ isOpen: false, question: null });
  ...
  const removeReviewerAssignment = async (questionId) => {
    ...
    try {
      ...
      message.error(
        `Failed to remove reviewer assignment: ${error.message || "Unknown error"
        }`
      );
    } finally {
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-50">
              ...
              <table className="w-full border-collapse">
                ...
                <tbody>
                  {sortedQuestions.length > 0 ? (
                    ...
                    <tr>
                      <td
                        colSpan={projectRole === "consultant admin" ? 9 : 8}
      ...
      {questionDetailsModal.isOpen && questionDetailsModal.question && (
                  ...
                  <div>
                    ...
                    <div className="text-gray-900 font-medium">
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                        {questionDetailsModal.question.type_description}
                      </span>
                    </div>
                  </div>
                  <div>
