...
const MyReports = () => {
  ...
  const handleRiskUpdate = async (e) => {
    ...
    if (!selectedSheet || !editingRisk) {
      message.error("Risk not selected");
      return;
    }
    setIsLoading(true);
    try {
  ...
  const handleViewRiskByObject = (risk) => {
    ...
    try {
      ...
      console.error(
        "Error preparing risk for viewing:",
  ...
  const handleExcelSubmit = async (e) => {
    ...
    if (!selectedSheet) {
      message.error("Please select a report first"); // Use message.error
      return;
    }
              ...
              {!selectedSheet && !isLoading && (
                <div className="flex flex-col items-center justify-center p-8 text-center">
                  ...
                  <p className="text-gray-500 mb-4">
                    Please select an existing report or create a new one to get
                    started.
                  </p>
                  <button
                  ...
                  {riskData.length === 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center p-10 text-center border-t border-slate-200 min-h-[300px]">
                      ...
                      <p className="text-gray-500 mb-6">
                        Get started by adding a risk assessment manually or
                          ...
                          <thead>
                            <tr className="bg-slate-100">
                              ...
                              <th
                                ...
                                colSpan={
                                  expandedGroups.impactAssessment ? 5 : 1
                                }
                              >
                              ...
                              <th
                                ...
                                colSpan={
                                  expandedGroups.controlAssessment ? 2 : 1
                                }
                              >
                                <div className="flex items-center justify-center">
                            ...
                            <tr className="bg-slate-50">
                              ...
                              {expandedGroups.riskRevision ? (
                                <>
                                  ...
                                  <th className="border border-slate-200 p-3 font-medium bg-indigo-100 transition-all duration-300">
                                    Will the planned controls meet legal/ other
                                    requirements? (Y/N)
                                  </th>
                                  <th className="border border-slate-200 p-3 font-medium bg-indigo-100 transition-all duration-300">
                              ...
                              riskData.map((risk, index) => (
                                ...
                                >
                                  ...
                                  <td className="border border-slate-200 p-3">
                                    <div className="flex space-x-2">
                                      <button
                                        ...
                                        title="View Risk"
                                        onClick={() => openModal("view", risk)} // Directly call openModal
                                      >
                                        {/* View Icon SVG */}
                                        <svg
                                          xmlns="http://www.w3.org/2000/svg"
                                      ...
                                      <button
                                        className="p-1 bg-blue-100 rounded hover:bg-blue-200 transition-colors"
                                        title="Edit Risk"
                                        onClick={() => openModal("edit", risk)} // Directly call openModal
                                      >
                                        {/* Edit Icon SVG */}
                                        <svg
                                          xmlns="http://www.w3.org/2000/svg"
                                  ...
                                  {expandedGroups.impactAssessment ? (
                                    <>
                                      <td
                                        className={`border border-slate-200 p-3 text-center ${getImpactColor(
                                  ...
                                  {expandedGroups.severity ? (
                                    ...
                                    <td className="border border-slate-200 p-3 text-center">
                                      C:{risk.severity.consequenceRating} L:
                                      {risk.severity.likelihoodRating}
                                    </td>
                                  )}
                                  ...
                                  {expandedGroups.controlAssessment ? (
                                    <>
                                      ...
                                      <td
                                        className={`border border-slate-200 p-3 text-center ${getControlRatingColor(
