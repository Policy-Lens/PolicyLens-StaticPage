...
const PolicyLibrary = () => {
    ...
    const [detailsModal, setDetailsModal] = useState({ isOpen: false, file: null });
                ...
                <div className="bg-white rounded-lg w-full max-w-2xl p-0 shadow-xl max-h-[90vh] overflow-hidden">
                    ...
                    <div className="p-6 overflow-y-auto max-h-[calc(90vh-8rem)]">
                        ...
                        <div className="mb-6 bg-blue-50 p-4 rounded-lg">
                            <h4 className="text-sm uppercase text-blue-700 font-semibold mb-3 border-b border-blue-200 pb-1">File Information</h4>
                        ...
                        <div className="mb-6 bg-gray-50 p-4 rounded-lg">
                            <h4 className="text-sm uppercase text-gray-700 font-semibold mb-3 border-b border-gray-200 pb-1">Regulation Information</h4>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <div className="text-gray-500 text-sm">Regulation Standard</div>
                                    <div className="text-gray-900 font-medium">{file.regulation_standard}</div>
                                </div>
                                <div>
                                    <div className="text-gray-500 text-sm">Regulation Control No.</div>
                                    <div className="text-gray-900 font-medium">{file.regulation_control_no}</div>
                                </div>
                                <div className="md:col-span-2">
                                    <div className="text-gray-500 text-sm">Regulation Control Name</div>
                                    <div className="text-gray-900 font-medium">{file.regulation_control_name}</div>
                                </div>
                                <div>
                                    <div className="text-gray-500 text-sm">Parent Control</div>
                                    <div className="text-gray-900 font-medium">{file.parent_control || "None"}</div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {file.assigned_by && (
                                    <div>
                                        ...
                                        <div className="text-gray-900 font-medium">{file.assigned_by.name}</div>
                                    </div>
                                )}
                                {file.assigned_to_details && (
                                    <div>
                                        <div className="text-gray-500 text-sm">Assigned To</div>
                                        <div className="text-gray-900 font-medium">{renderAssignedTo(file.assigned_to_details)}</div>
                                    </div>
                                )}
                                {file.created_at && (
                                    <div>
                                        ...
                                        <div className="text-gray-900 font-medium">{formatDate(file.created_at)}</div>
                                    </div>
                                )}
                                {file.updated_at && (
                                    <div>
                                        ...
                                        <div className="text-gray-900 font-medium">{formatDate(file.updated_at)}</div>
                                    </div>
                                )}
                            </div>
                        </div>
                ...
                {!isLoading && activeTab === "templates" && (
                    <div className="rounded-lg border border-gray-200 shadow-lg">
                      ...
                      {item.id}
                                        ...
                                        <td className="px-3 py-2.5 text-sm font-medium text-blue-600 cursor-pointer hover:underline"
                                        ...
                                        <td className="px-3 py-2.5 text-sm text-gray-900">
                                            <div className="flex space-x-2">
                                                <button
                                                    ...
                                                    title="View Details"
                                                    onClick={() => setDetailsModal({ isOpen: true, file: item })}
                                                >
