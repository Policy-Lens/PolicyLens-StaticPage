...
const AdminDashboardList = () => {
    ...
    console.log("AdminDashboardList component loaded");
    ...
    // Save dashboards to localStorage whenever they change (but not on initial load)
    const [isInitialLoad, setIsInitialLoad] = useState(true);

    useEffect(() => {
        if (!isInitialLoad) {
            console.log('Saving dashboards to localStorage:', dashboards);
            localStorage.setItem('adminDashboards', JSON.stringify(dashboards));
        }
    }, [dashboards, isInitialLoad]);

    // Mark initial load as complete after loading from localStorage
    useEffect(() => {
        const savedDashboards = localStorage.getItem('adminDashboards');
        console.log('Loading dashboards from localStorage:', savedDashboards);
        if (savedDashboards) {
            const parsedDashboards = JSON.parse(savedDashboards);
            console.log('Parsed dashboards:', parsedDashboards);
    ...
    const handleCreateDashboard = () => {
        ...
        console.log('Current dashboards before adding:', dashboards);
        const updatedDashboards = [...dashboards, newDashboard];
        console.log('Updated dashboards after adding:', updatedDashboards);
    ...
    // Function to save dashboard edits
    const handleSaveEdit = () => {
        ...
        const updatedDashboards = dashboards.map(dashboard =>
            dashboard.id === editingDashboard.id
                ? { ...dashboard, name: dashboardName, description: dashboardDescription }
                : dashboard
        );

        console.log('Updating dashboard:', editingDashboard.id);
        console.log('Updated dashboards:', updatedDashboards);
    ...
    // Function to navigate to a specific dashboard
                ...
                <div className="w-full">
                    ...
                    <div className="flex flex-col mb-8">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-gray-600">Manage and organize your analytics dashboards</p>
                            </div>
                    ...
                    {filteredDashboards.length > 0 ? (
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-5 whitespace-nowrap text-right text-sm font-medium">
                                                    <div className="flex items-center justify-end space-x-1">
                                                        ...
                                                        <ChevronRight size={18} className="text-gray-400 ml-2 group-hover:text-blue-500 transition-colors" />
                                                    </div>
                                                </td>
                                            </tr>
                                        ))}
                        ...
                        <div className="bg-gradient-to-br from-white to-gray-50 p-16 rounded-2xl border border-gray-100 text-center shadow-lg">
                            ...
                            <h3 className="text-2xl font-bold text-gray-800 mb-3">No Dashboards Yet</h3>
                            <p className="text-gray-600 mb-8 max-w-lg mx-auto text-lg">
                                Create your first dashboard to start organizing your charts and analytics.
                                Build beautiful visualizations and track your data insights.
                            </p>
                            <button
                                onClick={() => setIsCreateModalOpen(true)}
                    ...
                    <div className="bg-white rounded-2xl p-8 w-full max-w-lg shadow-2xl">
                        <div className="flex justify-between items-center mb-6">
                            <div className="flex items-center gap-3">
                                ...
                                <h2 className="text-2xl font-bold text-gray-800">Create New Dashboard</h2>
                            </div>
                            <button
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows="4"
                                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all shadow-sm hover:shadow-md resize-none"
                                />
                            </div>
                    ...
                    <div className="bg-white rounded-2xl p-8 w-full max-w-lg shadow-2xl">
                        <div className="flex justify-between items-center mb-6">
                            <div className="flex items-center gap-3">
                                ...
                                <h2 className="text-2xl font-bold text-gray-800">Edit Dashboard</h2>
                            </div>
                            <button
