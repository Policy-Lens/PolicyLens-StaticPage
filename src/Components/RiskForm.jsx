        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="col-span-2">
            ...
            <textarea
              ...
              onChange={(e) =>
                handleChange(e, "control_assessment", "description")
              }
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
              rows="3"
              required
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                handleNumericChange(e, "control_assessment", "rating")
              }
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
            >
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                handleNumericChange(e, "risk_assessment", "risk_rating")
              }
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
            >
              {ratingOptions.map((rating) => (
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleChange(e, "risk_assessment", "risk_category")
              }
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
              required
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleChange(e, "risk_assessment", "department_by")
              }
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
              required
            />
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                handleChange(e, "risk_assessment", "risk_mitigation_strategy")
              }
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
              required
            >
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleChange(e, "risk_revision", "applicable_soa_control")
              }
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700">
              Planned Controls Meet Requirements
            </label>
            <select
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                handleNumericChange(e, "risk_revision", "residual_risk_rating")
              }
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
            >
              {ratingOptions.map((rating) => (
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">
              Acceptable to Risk Owner
            </label>
            <select
              value={formData.risk_revision.acceptable_to_risk_owner}
              onChange={(e) =>
                handleChange(e, "risk_revision", "acceptable_to_risk_owner")
              }
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
            >
              {yesNoOptions.map((option) => (
          ...
          <div className="col-span-2">
            ...
            <textarea
              ...
              onChange={(e) =>
                handleChange(e, "mitigation_task", "task_description")
              }
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
              rows="2"
            ></textarea>
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                handleChange(e, "mitigation_task", "is_recurrent")
              }
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
            >
              {yesNoOptions.map((option) => (
