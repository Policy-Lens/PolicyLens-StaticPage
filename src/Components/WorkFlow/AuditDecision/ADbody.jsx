...
const ADbody = ({ projectId, refreshProjectData }) => {
  ...
  // Fetch Audit Decision data (step_no = 10)
  const fetchStepData = async () => {
    ...
    try {
      ...
      // Fetch fresh data
      const response = await getStepDetails(currentProjectId, 10);
      ...
      console.error('Error fetching Audit Decision data:', error);
