...
const FinalizeThePolicies = () => {
  ...
  return (
    <div className="p-8 bg-gray-50 flex-grow relative">
      ...
      <div>
        <h2 className="text-xl font-bold mb-4">Finalize Policies</h2>
        <Collapse className="mb-4">
          <Panel header="Enter Final Policy Details" key="1">
            {renderLargeInputWithAttachButton(
              "finalPolicies",
              "Provide final details or comments on the policies"
            )}
          </Panel>
        </Collapse>
      </div>
...
export default FinalizeThePolicies;
