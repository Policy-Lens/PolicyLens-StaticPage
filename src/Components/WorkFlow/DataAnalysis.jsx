...
import { UploadOutlined, FileTextOutlined, PaperClipOutlined, LoadingOutlined } from "@ant-design/icons";
...
const DataAnalysis = () => {
  ...
  const get_step_id = async () => {
    ...
    try {
      ...
      if (response) {
        console.log("API Response (Data Analysis):", response);
          ...
          <div className="text-center max-w-md mx-auto">
            ...
            >
              <span className="flex items-center space-x-2">
                ...
                <span>Add Analysis Documents</span>
              </span>
            </Button>
          </div>
        </div>
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-blue-600">
                <p>
                  ...
                  submitting your data analysis report.
                </p>
              </div>
              <div className="mt-3">
                <a
                ...
                >
                  ...
                  Download Data Analysis Template
                </a>
              </div>
            </div>
          </div>
