...
function FinalizeContract() {
  ...
  const getLatestUpdateTime = () => {
    ...
    const dates = finalizeContractData.map(item => new Date(item.saved_at).getTime());
  ...
  const getLatestUser = () => {
    ...
    const latestItem = finalizeContractData.find(item =>
  ...
  return (
    <div className="bg-gray-50 min-h-full p-6">
      ...
      <div className="mb-8 flex justify-between items-center">
        <h2 className="text-xl font-semibold text-gray-800">Finalize Contract</h2>
      ...
      {finalizeContractData.length > 0 ? (
        <div className="bg-white rounded-xl shadow-md overflow-hidden">
          ...
          <div className="p-6">
            ...
            <div className="flex flex-wrap justify-between items-center mb-6">
              <div>
                <h3 className="text-xl font-semibold text-gray-800">Contract Information</h3>
                {latestUpdateTime && (
        ...
        <div className="bg-white rounded-xl shadow-md p-10 text-center">
          <div className="max-w-md mx-auto">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">No Contract Data</h3>
            <p className="text-gray-500 mb-8 max-w-sm mx-auto">
              The contract section helps finalize the agreement between parties. Add your contract details to get started.
            </p>
            <Button
              onClick={handleAddData}
              type="primary"
      ...
      <Modal
        ...
        footer={[
          <Button key="cancel" onClick={handleModalClose} className="border-gray-300 text-gray-700">
            Cancel
          </Button>,
          <Button key="save" type="primary" onClick={handleSubmit} className="bg-blue-600 hover:bg-blue-700">
