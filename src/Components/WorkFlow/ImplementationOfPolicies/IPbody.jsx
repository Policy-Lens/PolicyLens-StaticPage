...
const IPbody = ({ projectId, refreshProjectData }) => {
  ...
  // Fetch Implementation of Policies data (step_no = 8)
  const fetchStepData = async () => {
    ...
    try {
      ...
      // Fetch fresh data
      const response = await getStepDetails(currentProjectId, 8);
      ...
      console.error('Error fetching Implementation of Policies data:', error);
      message.error('Failed to load Implementation of Policies data');
    } finally {
      setIsLoading(false);
    }
  };
