...
import SRedit from "./SRedit";

const SRbody = ({ projectId, refreshProjectData }) => {
  ...
  // Fetch Service Requirements data (step_no = 1)
  const fetchStepData = async () => {
    ...
    try {
      ...
      // Fetch fresh data
      const response = await getStepDetails(currentProjectId, 1);
      ...
      console.error('Error fetching Service Requirements data:', error);
