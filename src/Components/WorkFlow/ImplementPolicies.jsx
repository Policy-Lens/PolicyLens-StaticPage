...
function ImplementPolicies() {
  ...
  const get_step_data = async (step_id) => {
    ...
    try {
      ...
      message.error("Failed to load implementation data");
    } finally {
      setIsLoading(false);
    }
  };
                ...
                {implementPoliciesData[0].saved_at && (
                  <div className="flex items-center mt-1">
                    ...
                    <span className="text-xs text-gray-500">
                      Last updated {formatDate(implementPoliciesData[0].saved_at)}
                    </span>
                  </div>
                )}
              </div>
                ...
                <div className="flex items-center bg-gray-50 px-3 py-1 rounded-lg">
                  ...
                  <div className="ml-2">
                    <p className="text-sm font-medium text-gray-800">
                      {implementPoliciesData[0].saved_by?.name || "Unknown"}
                    </p>
                    <p className="text-xs text-gray-500">
                      {implementPoliciesData[0].saved_by?.email || "N/A"}
                    </p>
                  </div>
                </div>
              )}
                            ...
                            <div key={doc.id} className="flex items-center">
                              ...
                              <div className="overflow-hidden flex-grow">
                                <button
                                  ...
                                  className="text-xs text-blue-700 truncate hover:underline flex items-center gap-2 disabled:opacity-60"
