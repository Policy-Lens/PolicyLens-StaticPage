      ...
      {gapAnalysisData.length > 0 ? (
        ...
        <div className="bg-gradient-to-br from-white to-blue-50 rounded-xl shadow-md border border-gray-100 p-6 flex flex-col items-center justify-center min-h-[300px]">
          <div className="text-center max-w-md mx-auto">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">No Gap Analysis Data</h3>
            ...
            >
              <span className="flex items-center space-x-2">
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h5V4a1 1 0 011-1z"
                    clipRule="evenodd"
                  />
                </svg>
              ...
              showInsightsPanel && (
                <div className="mt-3 border rounded-md p-3 bg-gray-50">
                  <p className="text-sm text-gray-500 italic">
                    No stakeholder insights available. Complete the stakeholder interviews first.
                  </p>
                </div>
              )
            )}
