...
const FCbody = ({ projectId, refreshProjectData }) => {
  ...
  // Fetch Finalize Contract data (step_no = 2)
  const fetchStepData = async () => {
    ...
    try {
      ...
      // Fetch fresh data
      const response = await getStepDetails(currentProjectId, 2);
      ...
      console.error('Error fetching Finalize Contract data:', error);
      message.error('Failed to load Finalize Contract data');
    } finally {
      setIsLoading(false);
    }
  };
