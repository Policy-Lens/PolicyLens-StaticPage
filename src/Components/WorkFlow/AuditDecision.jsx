...
function AuditDecision() {
  ...
  const [auditDecisionData, setAuditDecisionData] = useState([]);
  ...
  const handleSubmit = async () => {
    ...
    formData.append("field_name", "Audit Decision");
    ...
    try {
      ...
      if (response.status === 201) {
        message.success("Audit decision submitted successfully!");
        ...
        message.error("Failed to submit audit decision.");
      }
    } catch (error) {
      message.error("Failed to submit audit decision.");
      console.error(error);
  ...
  const get_step_id = async () => {
    ...
    try {
      ...
      if (response) {
        ...
        console.log("API Response (Audit Decision):", response);
        console.log("Associated ISO Clause (Audit Decision):", response.associated_iso_clause);
        console.log("Process (Audit Decision):", response.process);
      ...
      message.error("Failed to load audit decision data.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const AuditDecisionCard = ({ data, onUpdateClick, assignedUser, taskAssignment }) => {
        ...
        <div className="bg-gradient-to-br from-white to-blue-50 rounded-xl shadow-md border border-gray-100 p-6 flex flex-col items-center justify-center min-h-[300px]">
          <div className="text-center max-w-md mx-auto">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">
              No Audit Decision Data
            </h3>
            <p className="text-gray-600 mb-8 leading-relaxed">
              The audit decision section helps finalize the audit process outcomes.
              Add your decision details to get started.
            </p>
            <Button
        ...
        <div className="grid md:grid-cols-3 divide-x divide-gray-100">
          ...
          <div className="md:col-span-2 p-6">
            ...
            <div className="flex items-start justify-between mb-5">
              <div>
                <h2 className="text-xl font-bold text-gray-800">Audit Decision</h2>
            ...
            <div className="mb-6">
              <h3 className="text-sm font-medium text-gray-700 uppercase mb-3">Decision Details</h3>
            ...
            <div className="mb-6 space-y-4">
              ...
              <div className="border-l-2 border-blue-200 pl-4 space-y-3 mb-4 relative">
                ...
                {latestData.updated_at && latestData.updated_at !== latestData.created_at && (
                  <>
                    <div className="absolute w-3 h-3 bg-blue-500 rounded-full -left-[7px] top-16"></div>
                    <div className="flex items-start">
                      <div className="flex-1">
              ...
              <div className="p-6">
                ...
                <div className="bg-white p-3 rounded-lg shadow-sm border border-gray-100 space-y-3">
                  ...
                  {taskAssignment.references && (
                    <div>
                      <h4 className="text-xs text-gray-500 mb-1">References</h4>
                      <p className="text-sm text-gray-800">{taskAssignment.references}</p>
                    </div>
                  )}
                </div>
              </div>
      ...
      <Modal
        ...
        footer={[
          ...
          <Button
            ...
            loading={loading}
          >
            {auditDecisionData.length > 0 ? "Update" : "Save"}
          </Button>,
        ]}
        width={700}
      >
          ...
          <div className="space-y-6">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-blue-600">
                    <p>
                      ...
                      submitting your audit decision.
                    </p>
                  </div>
                  <div className="mt-3">
                    <a
                      href="/templates/Audit_Decision_template.xlsx"
                      download="audit_decision_template.xlsx"
                    ...
                    >
                      ...
                      Download Audit Decision Template
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <TextArea
                id="description"
                rows={6}
                placeholder="Enter the audit decision details and recommendations"
                value={description}
