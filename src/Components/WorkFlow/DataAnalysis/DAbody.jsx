...
import DAview from "./DAview";
import DAedit from "./DAedit";

const DAbody = ({ projectId, refreshProjectData }) => {
  ...
  // Fetch Data Analysis data (step_no = 5)
  const fetchStepData = async () => {
    ...
    try {
      ...
      // Fetch fresh data
      const response = await getStepDetails(currentProjectId, 5);
      ...
      console.error('Error fetching Data Analysis data:', error);
      message.error('Failed to load Data Analysis data');
    } finally {
      setIsLoading(false);
    }
  };
