...
const PDPbody = ({ projectId, refreshProjectData }) => {
  ...
  // Fetch Planning and Discussing Policies data (step_no = 7)
  const fetchStepData = async () => {
    ...
    try {
      ...
      // Fetch fresh data
      const response = await getStepDetails(currentProjectId, 7);
      ...
      console.error('Error fetching Planning and Discussing Policies data:', error);
      message.error('Failed to load Planning and Discussing Policies data');
    } finally {
      setIsLoading(false);
    }
  };
