...
import { Button, Modal, Input, Upload, message, Spin, Dropdown, Select, DatePicker } from "antd";
import {
  PaperClipOutlined,
  FileTextOutlined,
  LoadingOutlined,
...
function ServiceRequirements() {
  ...
  const { addStepData, getStepData, getStepId, projectRole, checkStepAuth, assignStep, getStepAssignment, getMembers } =
        ...
        <div className="flex gap-2">
          ...
          {(projectRole.includes("admin") || isAssignedUser) && (
            <Button
              ...
              disabled={loading}
            >
              {serviceRequirementsData.length > 0 ? "Update Requirements" : "Add Requirements"}
            </Button>
          )}
        </div>
      </div>
                ...
                {serviceRequirementsData[0]?.saved_at && (
                  <div className="flex items-center mt-1">
                    ...
                    <span className="text-xs text-gray-500">
                      Last updated{" "}
                      {formatDate(serviceRequirementsData[0].saved_at)}
                    </span>
                  </div>
                )}
              </div>
                ...
                <div className="flex items-center bg-gray-50 px-3 py-1 rounded-lg">
                  <div className="flex-shrink-0">
                    <div className="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center text-white font-bold text-sm shadow-inner">
                      {serviceRequirementsData[0].saved_by.name
                        .charAt(0)
                        .toUpperCase()}
                    </div>
                  </div>
                  <div className="ml-2">
                    ...
                    <p className="text-xs text-gray-500">
                      {serviceRequirementsData[0].saved_by.email}
                    </p>
                  </div>
                </div>
              )}
        ...
        <div className="bg-white rounded-xl shadow-md p-10 text-center">
          <div className="max-w-md mx-auto">
            ...
            <p className="text-gray-500 mb-8 max-w-sm mx-auto">
              Service requirements help define what needs to be delivered for
              this project. Add your first requirement to get started.
            </p>
            <Button
              onClick={() => setIsModalVisible(true)}
              type="primary"
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-blue-600">
                    <p>Please download and fill in the template below before submitting your service requirements.</p>
                  </div>
                  <div className="mt-3">
                    <a
                      href="/temp.txt"
                      download="service_requirements_template.txt"
