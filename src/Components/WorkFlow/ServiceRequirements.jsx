  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        {(projectRole.includes("admin") || isAssignedUser) && (
          <Button type="primary" onClick={() => setIsModalVisible(true)} className="bg-blue-500">
            {serviceRequirementsData.length > 0 ? "Update Data" : "Add Data"}
          </Button>
        )}
      </div>
      ...
      {serviceRequirementsData.length > 0 && (
        <>
          <h3 className="text-lg font-semibold text-gray-800 mb-4">Service Requirements Details</h3>
      ...
      {serviceRequirementsData.length === 0 && (
        <div className="text-center text-gray-500 my-10">
          <p>No service requirements data available.</p>
