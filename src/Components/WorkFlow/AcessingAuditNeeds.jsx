...
const AccessingAuditNeeds = () => {
  ...
  const handleScheduleMeeting = () => {
    if (selectedMeetingType) {
      alert(`Schedule Meeting with ${selectedMeetingType} clicked!`);
    } else {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 relative">
      ...
      <h1 className="text-2xl font-bold text-gray-800 mb-4">
        Accessing Audit Needs
      </h1>

      {/* Buttons Section */}
      <div className="space-y-6">
        {/* Dropdown and Single Schedule Meeting Button */}
        <div>
          ...
          >
            <Option value="External Auditor">With External Auditor</Option>
            <Option value="Team">With Team</Option>
            <Option value="Company Representatives">With Company Representatives</Option>
          </Select>
          <button
          ...
          <p className="text-sm text-gray-600 mt-2">
            Schedule a meeting based on the selected type.
          </p>
        </div>
...
export default AccessingAuditNeeds;
